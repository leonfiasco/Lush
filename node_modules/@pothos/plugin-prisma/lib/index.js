...
require("./global-types.js");
require("./schema-builder.js");
require("./field-builder.js");
const _core = /*#__PURE__*/ _interop_require_wildcard(require("@pothos/core"));
const _prismafieldbuilder = require("./prisma-field-builder.js");
const _cursors = require("./util/cursors.js");
const _datamodel = require("./util/datamodel.js");
const _loadermap = require("./util/loader-map.js");
const _mapquery = require("./util/map-query.js");
const _connectionhelpers = require("./connection-helpers.js");
const _interfaceref = require("./interface-ref.js");
const _noderef = require("./node-ref.js");
const _objectref = require("./object-ref.js");
_export_star(require("./types.js"), exports);
const _getclient = require("./util/get-client.js");
...
_core.default.registerPlugin(pluginName, PothosPrismaPlugin, {
    v3: (options)=>{
        ...
        return {
            prisma: {
                ...options.prisma,
                filterConnectionTotalCount: (_ref = (_options_prisma = options.prisma) === null || _options_prisma === void 0 ? void 0 : _options_prisma.filterConnectionTotalCount) !== null && _ref !== void 0 ? _ref : false
            }
        };
    }
});
