...
const _selections = require("./util/selections.js");
...
class ModelLoader {
    ...
    static getCursorSelection(ref, modelName, cursor, builder) {
        ...
        if (!index) {
            throw new _core.PothosSchemaError(`Can't find "${cursor}" field or index for ${ref.name}`);
        }
        const selection = {};
    ...
    static getFindUniqueForField(ref, modelName, fieldName, builder) {
        ...
        if (model.fields.some((field)=>field.name === fieldName)) {
            findBy = fieldName;
        } else if (model.primaryKey && ((_ref = (_model_primaryKey = model.primaryKey) === null || _model_primaryKey === void 0 ? void 0 : _model_primaryKey.name) !== null && _ref !== void 0 ? _ref : (_model_primaryKey1 = model.primaryKey) === null || _model_primaryKey1 === void 0 ? void 0 : _model_primaryKey1.fields.join('_')) === fieldName) {
            findBy = model.primaryKey;
        } else if (uniqueIndex) {
            findBy = uniqueIndex;
        }
    ...
    initLoad(state, initialModel) {
        const delegate = (0, _datamodel.getDelegateFromModel)((0, _getclient.getClient)(this.builder, this.context), this.modelName);
