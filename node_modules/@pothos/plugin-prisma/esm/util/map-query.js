...
import { GraphQLIncludeDirective, GraphQLSkipDirective, getDirectiveValues, getNamedType, isInterfaceType, isObjectType, Kind } from 'graphql';
            ...
            case Kind.FIELD:
                if (expectedType.name === type.name && !fieldSkipped(info, sel) && sel.name.value === include.name && (isObjectType(type) || isInterfaceType(type))) {
                    ...
                    resolveIndirectInclude(returnType, info, sel, rest, [
                        ...path,
                        (_ref = (_sel_alias = sel.alias) === null || _sel_alias === void 0 ? void 0 : _sel_alias.value) !== null && _ref !== void 0 ? _ref : sel.name.value
                    ], resolve, deferred);
                }
                continue;
...
function addFieldSelection(type, context, info, state, selection, indirectPath) {
    ...
    if (typeof fieldSelect === 'function') {
        const args = getMappedArgumentValues(field, selection, context, info);
        fieldSelectionMap = fieldSelect(args, context, (rawQuery, indirectInclude, expectedType)=>{
            ...
            if (!!(normalizedIndirectInclude === null || normalizedIndirectInclude === void 0 ? void 0 : normalizedIndirectInclude.path) && normalizedIndirectInclude.path.length > 0 || !!(normalizedIndirectInclude === null || normalizedIndirectInclude === void 0 ? void 0 : normalizedIndirectInclude.paths) && normalizedIndirectInclude.paths.length > 0) {
                ...
                resolveIndirectIncludePaths(returnType, info, selection, (_ref = (_returnType_extensions = returnType.extensions) === null || _returnType_extensions === void 0 ? void 0 : (_returnType_extensions_pothosIndirectInclude = _returnType_extensions.pothosIndirectInclude) === null || _returnType_extensions_pothosIndirectInclude === void 0 ? void 0 : _returnType_extensions_pothosIndirectInclude.path) !== null && _ref !== void 0 ? _ref : [], (_ref1 = normalizedIndirectInclude === null || normalizedIndirectInclude === void 0 ? void 0 : normalizedIndirectInclude.paths) !== null && _ref1 !== void 0 ? _ref1 : (normalizedIndirectInclude === null || normalizedIndirectInclude === void 0 ? void 0 : normalizedIndirectInclude.path) ? [
    ...
    if (fieldSelect && selectionCompatible(state, fieldSelectionMap, true)) {
        ...
        state.mappings = mergeMappings(state.mappings, {
            [(_ref = (_selection_alias = selection.alias) === null || _selection_alias === void 0 ? void 0 : _selection_alias.value) !== null && _ref !== void 0 ? _ref : selection.name.value]: {
...
export function queryFromInfo({ context, info, typeName, select, include, path = [], paths = [], withUsageCheck = false, skipDeferredFragments = true }) {
    ...
    if (path.length > 0 || paths.length > 0) {
        var _returnType_extensions, _ref;
        ...
        resolveIndirectInclude(returnType, info, info.fieldNodes[0], (_ref = pothosIndirectInclude === null || pothosIndirectInclude === void 0 ? void 0 : pothosIndirectInclude.path) !== null && _ref !== void 0 ? _ref : [], [], (indirectType, indirectField, subPath, deferred)=>{
...
export function getIndirectType(type, info) {
    ...
    while((_targetType_extensions = targetType.extensions) === null || _targetType_extensions === void 0 ? void 0 : _targetType_extensions.pothosIndirectInclude){
        targetType = info.schema.getType(targetType.extensions.pothosIndirectInclude.getType());
    }
    return targetType;
}
function normalizeInclude(path, type, expectedType) {
    ...
    return {
        getType: ()=>{
            var _ref;
            return (_ref = expectedType === null || expectedType === void 0 ? void 0 : expectedType.name) !== null && _ref !== void 0 ? _ref : normalized.length > 0 ? normalized[normalized.length - 1].type : type.name;
        },
        path: normalized
    };
}
