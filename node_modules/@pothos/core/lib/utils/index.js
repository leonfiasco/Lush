...
const _inputlist = require("../refs/input-list.js");
const _list = require("../refs/list.js");
const _index = require("../types/index.js");
_export_star(require("./base64.js"), exports);
_export_star(require("./context-cache.js"), exports);
_export_star(require("./enums.js"), exports);
_export_star(require("./input.js"), exports);
_export_star(require("./params.js"), exports);
_export_star(require("./sort-classes.js"), exports);
...
function brandWithType(val, type) {
    ...
    Object.defineProperty(val, _index.typeBrandKey, {
        enumerable: false,
        value: type
    });
}
function getTypeBrand(val) {
    if (typeof val === 'object' && val !== null && _index.typeBrandKey in val) {
        return val[_index.typeBrandKey];
    }
    return null;
}
