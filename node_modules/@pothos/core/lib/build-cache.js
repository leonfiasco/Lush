...
const _builtinscalar = require("./refs/builtin-scalar.js");
const _index1 = require("./types/index.js");
...
class BuildCache {
    ...
    buildFields(fields) {
        ...
        for (const [fieldName, originalConfig] of fields){
            var _config_resolve, _config_resolve1;
    ...
    buildInterface(config) {
        const resolveType = (parent, context, info)=>{
            ...
            const typeBrand = (0, _index2.getTypeBrand)(parent);
            if (typeBrand) {
    ...
    buildUnion(config) {
        const resolveType = (parent, context, info, type)=>{
            if (typeof parent === 'object' && parent !== null && _index1.typeBrandKey in parent) {
                const typeBrand = parent[_index1.typeBrandKey];
                if (typeof typeBrand === 'string') {
                    return typeBrand;
                }
                return this.getTypeConfig(typeBrand).name;
            ...
            return (0, _index2.isThenable)(resultOrPromise) ? resultOrPromise.then(getResult) : getResult(resultOrPromise);
        };
    ...
    constructor(builder, options){
        ...
        this.plugin = new _index.MergedPlugins(this, this.pluginList);
    }
}
