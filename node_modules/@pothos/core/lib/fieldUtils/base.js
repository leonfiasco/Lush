...
const _field = require("../refs/field.js");
    ...
    options) {
        const ref = new _field.FieldRef(this.kind, (name, typeConfig)=>{
            ...
            return {
                ...
                args,
                argMappers: [],
                type: (0, _index.typeFromParam)(options.type, this.builder.configStore, (_options_nullable = options.nullable) !== null && _options_nullable !== void 0 ? _options_nullable : this.builder.defaultFieldNullability),
