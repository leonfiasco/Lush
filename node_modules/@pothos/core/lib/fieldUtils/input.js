...
const _arg = require("../refs/arg.js");
const _inputfield = require("../refs/input-field.js");
...
class InputFieldBuilder {
   ...
   */ field(options) {
        const ref = this.kind === 'Arg' ? new _arg.ArgumentRef((name, field, typeConfig)=>{
            ...
            return {
                ...
                type: (0, _index.inputTypeFromParam)(opts.type, this.builder.configStore, (_opts_required = opts.required) !== null && _opts_required !== void 0 ? _opts_required : this.builder.defaultInputFieldRequiredness),
                pothosOptions: opts,
   ...
   */ _define_property(this, "stringList", this.helper([
        ...
        _define_property(this, "listRef", (type, options)=>{
            var _ref;
            return new _inputlist.InputListRef(type, (_ref = options === null || options === void 0 ? void 0 : options.required) !== null && _ref !== void 0 ? _ref : true);
        });
