...
class MergedPlugins extends _plugin.BasePlugin {
    ...
    wrapResolve(resolve, fieldConfig) {
        ...
        return this.wrapArgMappers((parent, args, context, info)=>{
            const mappedArgs = (0, _index.reduceMaybeAsync)(argMappers, args, (acc, argMapper)=>{
                return argMapper(acc, context, info);
            });
            return (0, _index.completeValue)(mappedArgs, (mappedArgs)=>wrapped(parent, mappedArgs, context, info));
        }, fieldConfig);
    }
