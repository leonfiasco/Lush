...
export class SchemaBuilder {
    ...
    scalarType(name, options) {
        const ref = new ScalarRef(name, {
            ...
            ...options.coerceOutputValue ? {
                coerceOutputValue: options.coerceOutputValue
            } : {},
            ...options.coerceInputValue ? {
                coerceInputValue: options.coerceInputValue
            } : {},
            ...options.coerceInputLiteral ? {
                coerceInputLiteral: options.coerceInputLiteral
            } : {},
            ...options.valueToLiteral ? {
                valueToLiteral: options.valueToLiteral
            } : {},
            pothosOptions: options,
            extensions: options.extensions,
            astNode: options.astNode
    ...
    constructor(options){
        var _options_defaultFieldNullability, _options_defaultInputFieldRequiredness;
